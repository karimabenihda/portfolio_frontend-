...
export default function Hero() {
  return (
    <section className="hero-section relative w-full min-h-screen bg-[#f8f7ff] overflow-hidden flex flex-col items-center justify-between py-12 px-6 md:px-12 lg:px-20 z-10">

      {/* Background Huge Text - Layered behind person */}
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none">
        <motion.h1
          className="text-[25vw] md:text-[22vw] lg:text-[400px] font-bartle font-black text-blue-600 leading-none tracking-tighter select-none opacity-100 z-0"
      ...
      <div className="max-w-[1400px] mx-auto w-full h-full flex flex-col items-center relative z-10">
        ...
        >
          <span className="text-7xl md:text-8xl lg:text-[140px] font-gruppo italic text-black leading-none py-1">I'm</span>
          <span className="text-7xl md:text-8xl lg:text-[140px] font-gruppo italic text-black leading-none py-1">ui/ux</span>
        </motion.div>


        {/* Central Person Image */}
        <div className="absolute top-[100%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] flex justify-center items-center pointer-events-none z-100">
          <motion.div
