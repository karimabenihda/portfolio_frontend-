...
function Panel01() {
  ...
  return (
    <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "3rem", padding: "0 2rem", flexWrap: "wrap", width: "100%", maxWidth: "1000px" }}>
      ...
      <div style={{ flex: "1 1 280px", maxWidth: "360px" }}>
        ...
        <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(2.5rem,6vw,5rem)", lineHeight: 0.9, color: "#39ff14", marginBottom: "1.25rem", letterSpacing: "0.02em" }}>
          Karima<br />Benihda
        </h2>
        <p style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
          Frontend &amp; Full-Stack Developer building web apps and AI-powered products —
          from pixel-perfect UIs to LLM pipelines and ML systems.
        </p>
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
          {["React", "Next.js", "Python", "AI / LLMs"].map(tag => (
      ...
      <div style={{ flex: "1 1 300px", maxWidth: "360px", borderRadius: "12px", background: "#18181b", overflow: "hidden", boxShadow: "0 0 0 1px rgba(57,255,20,0.12), 0 24px 48px rgba(0,0,0,0.5)" }}>
        ...
        <div style={{ padding: "16px 18px", fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", lineHeight: 1.85 }}>
          ...
          {[
            ...
            { key: "role",     val: `"Frontend & Full-Stack Dev"` },
            { key: "age",      val: age },
...
function Panel05() {
  const links = [
    { label: "Email", value: "karima@email.com", href: "mailto:karima@email.com" },
  ...
  return (
    <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "0 2rem", maxWidth: "600px" }}>
...
export default function ScrollLoop() {
  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .scroll-loop-container {
          position: relative; width: 100%; background: #060606;
        ...
        .panel--intro {
          background: #060606; flex-direction: column; gap: 2rem; text-align: center;
        }
        .panel--intro::before {
      ...
      <div className="scroll-loop-container" ref={containerRef}>

        {/* ── Intro Panel ── */}
        <div className="panel panel--intro">
          <p className="intro-eyebrow">karima benihda · portfolio</p>
          <h1 className="intro-title">
            Frontend<span>Developer</span>
          </h1>
          <p className="intro-sub">
            Full-Stack &amp; AI Engineer · Ait Melloul, Morocco
          </p>
        ...
        {PANELS.slice(1).map((p, i) => {
          ...
          return (
            <section
              key={p.id}
              className="panel panel--numbered"
            ...
            >
              ...
              {/* Corners */}
              <span className="panel__corner panel__corner--tl">Karima Benihda</span>
              ...
              <span className="panel__side-text">Frontend · Full-Stack · AI — Portfolio</span>
